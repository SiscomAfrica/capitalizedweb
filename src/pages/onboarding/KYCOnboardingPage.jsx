...
const KYCOnboardingPage = () => {
  ...
  const { getNextStepMessage, progress, currentStep } = useOnboarding();
  ...
  useEffect(() => {
    if (user) {
      ...
      // If user shouldn't be on this page (profile not completed), redirect appropriately
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Call API to update profile (this should also mark KYC as completed)
      const response = await authClient.updateProfile(updateData);

      // Update user context - mark KYC as completed (basic info provided)
      updateUser({
        ...response,
      ...
      console.error('KYC completion failed:', err);
  ...
  // Handle skip (allow access to dashboard without completing KYC)
  const handleSkip = () => {
    // Mark KYC as skipped but allow dashboard access
    updateUser({
      kyc_status: 'skipped',
      kycStatus: 'skipped'
    });
        ...
        <Card className="p-8">
          ...
          {success && (
            ...
            >
              ...
              <div>
                <p className="text-success-800 font-medium">KYC information completed successfully!</p>
                <p className="text-success-600 text-sm">
                  Your basic information has been saved. Redirecting to your dashboard...
                </p>
              </div>
            </motion.div>
          )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-primary-700">
                    This information helps us comply with financial regulations and provide you with 
                    personalized investment opportunities. All data is securely encrypted and protected.
                  </p>
                </div>
              </div>
            </div>
